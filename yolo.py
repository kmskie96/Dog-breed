...
class YOLO(object):
    ...
    def __init__(self, **kwargs):
        ...
        self.class_names = kwargs.get('class_names') \
            if kwargs.get('class_names') is not None else self._get_class()
        self.anchors = kwargs.get('anchors') \
            if kwargs.get('anchors') is not None else self._get_anchors()
    ...
    def detect_image(self, image, box_info=False):
        start = timer()
        ...
        for i, c in reversed(list(enumerate(out_classes))):
            ...
            box = out_boxes[i]
            score = out_scores[i]
            box_infos.append((predicted_class, box, score))
